...
--
    and COMTCADMINISTCODE.ADMINIST_ZONE_CODE like '43' || '720' || '%' /* 青沥内靛.青沥备开内靛 矫档 面没合档 焊篮焙 */
    and COMTCADMINISTCODE.ADMINIST_ZONE_CODE != '43' || '720' || '00000' /* 青沥内靛.青沥备开内靛 矫档 面没合档 焊篮焙 */
order by
--    COMTCADMINISTCODE.ADMINIST_ZONE_CODE /* 青沥内靛.青沥备开内靛 */
    COMTCADMINISTCODE.ADMINIST_ZONE_NM /* 青沥内靛.青沥备开疙 */
;
