...
--    and COMTCADMINISTCODE.ADMINIST_ZONE_CODE like '________00' /* 青沥内靛.青沥备开内靛 谰搁悼 3 */
...
--    and COMTCADMINISTCODE.ADMINIST_ZONE_CODE like '30' || '110' || '' || '%' /* 青沥内靛.青沥备开内靛 矫档 措傈 悼备 */
--    and COMTCADMINISTCODE.ADMINIST_ZONE_CODE != '30110' || '00000' /* 青沥内靛.青沥备开内靛 矫档 措傈 */
--
    and COMTCADMINISTCODE.ADMINIST_ZONE_CODE like '43' || '720' || '350' || '%' /* 青沥内靛.青沥备开内靛 面没合档 焊篮焙 伙铰搁 */
    and COMTCADMINISTCODE.ADMINIST_ZONE_CODE != '43' || '720' || '350' || '00' /* 青沥内靛.青沥备开内靛 面没合档 焊篮焙 伙铰搁 */
order by
--    COMTCADMINISTCODE.ADMINIST_ZONE_CODE /* 青沥内靛.青沥备开内靛 */
    COMTCADMINISTCODE.ADMINIST_ZONE_NM /* 青沥内靛.青沥备开疙 */
;
