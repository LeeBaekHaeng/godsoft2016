...
public class EgovBBSManageController {
	...
	public String selectBoardArticles(
		...
		// vo.getBbsAttrbCode());
		Map<String, Object> map = bbsMngService.selectBoardArticles(boardVO,
				master.getBbsAttrbCode());// 2011.09.07
	...
	public String addBoardArticle(@ModelAttribute("searchVO") BoardVO boardVO,
	...
	public String selectGuestList(@ModelAttribute("searchVO") BoardVO boardVO,
			ModelMap model) throws Exception {
	...
	public String selectSingleGuestList(
			@ModelAttribute("searchVO") BoardVO boardVO,
	...
	public String deleteGuestList(@ModelAttribute("searchVO") BoardVO boardVO,
	...
	public String updateGuestList(@ModelAttribute("searchVO") BoardVO boardVO,
			@ModelAttribute("board") Board board, BindingResult bindingResult,
			ModelMap model) throws Exception {
	...
	public String insertAnonymousBoardArticle(
		...
		if (isAuthenticated) {
			...
			board.setPassword(EgovFileScrty.encryptPassword(
					board.getPassword(), boardVO.getBbsId()));
	...
	public String selectAnonymousBoardArticleForUpdt(
		...
		if (isAuthenticated) {
			...
			String enpassword = EgovFileScrty.encryptPassword(
					boardVO.getPassword(), boardVO.getBbsId());
	...
	public String previewBoardArticles(
			@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model)
			throws Exception {
		// LoginVO user = (LoginVO)EgovUserDetailsHelper.getAuthenticatedUser();
