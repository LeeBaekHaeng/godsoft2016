...
rem set REPOS_PATH=D:\Repositories-sync\kosii-study2015_%god_yyyymmddhhmmss_a1%
set TYPE_NUL="%REPOS_PATH%\hooks\pre-revprop-change.cmd"

set MIRROR_URL="file:///%REPOS_PATH%"
rem set SOURCE_URL=https://dev.naver.com/svn/kosii-study2015
...
rem svnsync help
rem svnsync help init
rem svnsync help sync
